            ...
            switch (event.type) {
                ...
                case sf::Event::KeyPressed:
                    ...
                    if (event.key.code == sf::Keyboard::Num2) { 
                        player1.MovePiece(1, 0, dice.Roll(), board, circle, player2.px);
                    }
                    if (event.key.code == sf::Keyboard::Num3) {
                        player1.MovePiece(2, 0, dice.Roll(), board, circle, player3.px);
                    }
                    if (event.key.code == sf::Keyboard::Num4) {
                        player1.MovePiece(3, 0, dice.Roll(), board, circle, player4.px);
                    }
                    break;
